...
features1 = utils.get_second_column("../../../../../Dataset/UCM_age.csv",seek=13)
features2 = utils.get_second_column("../../../../../Dataset/UCM_region.csv",seek=13)
features = features1 + features2

entity1 = utils.get_first_column("../../../../../Dataset/UCM_age.csv",seek=13)
entity2 = utils.get_first_column("../../../../../Dataset/UCM_region.csv",seek=13)
...
sps.save_npz("../../../../../Dataset/UCM_all.npz", UCM_all)
