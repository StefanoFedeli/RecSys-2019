...
features1 = utils.get_second_column("../../../../Dataset/ICM/ICM_sub_class.csv", seek=13)
features2 = utils.get_second_column("../../../../Dataset/ICM/ICM_price.csv", seek=13)
features3 = utils.get_second_column("../../../../Dataset/ICM/ICM_asset.csv", seek=13)
features = features1 + features2 + features3

items1 = utils.get_first_column("../../../../Dataset/ICM/ICM_sub_class.csv", seek=13)
items2 = utils.get_first_column("../../../../Dataset/ICM/ICM_price.csv", seek=13)
items3 = utils.get_first_column("../../../../Dataset/ICM/ICM_asset.csv", seek=13)
...
'''
#sps.save_npz("../../../../Dataset/ICM/ICM_all.npz", ICM_all)
