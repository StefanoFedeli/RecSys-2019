...
URM_all = sps.coo_matrix(sps.load_npz("../../Dataset/old/data_all.npz"))
URM_train = sps.coo_matrix(sps.load_npz("../../Dataset/old/data_train.npz"))
URM_test = sps.csr_matrix(sps.load_npz("../../Dataset/old/data_test.npz"))

features1 = utils.get_second_column("../../Dataset/UCM/UCM_age.csv")
features2 = utils.get_second_column("../../Dataset/UCM/UCM_region.csv")
features = features1 + features2

entity1 = utils.get_first_column("../../Dataset/UCM/UCM_age.csv")
entity2 = utils.get_first_column("../../Dataset/UCM/UCM_region.csv")
