...
users = utils.get_target_users("../../Dataset/target_users_warm.csv", seek=8)
...
"""
massim = 0.04155 #alpha=0.000, beta=0.000, gamma=9.375, d=7.852, e=0.000, f=2.023, g=1.194, h=8.891 i=0.000, l=0.000, norm:True
for i in range(50):
    ...
    result = valid.evaluate(users, rec_sys, URM_test, 10)["MAP"]
    ...
    #    massim = results[0][10]["MAP"]
        ...
        print("{0}: {1} @ {2:.5f}".format(i, rec_sys, result))
...
rec_sys.fit(n=True, alpha=0.000, beta=0.000, gamma=9.375, d=7.852, e=0.000, f=2.023, g=1.194, h=8.891, i=0.000, l=0.000)
with open("../../Outputs/HybridNormalized.csv", 'w') as f:
