...
features1 = utils.get_features("../../refinedDataSet/UCM_age.csv")
features2 = utils.get_features("../../refinedDataSet/UCM_region.csv")
...
entity1 = utils.get_entity("../../refinedDataSet/UCM_age.csv")
entity2 = utils.get_entity("../../refinedDataSet/UCM_region.csv")
