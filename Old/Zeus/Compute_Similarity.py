...
from Old.Zeus.Compute_Similarity_Euclidean import Compute_Similarity_Euclidean
    ...
    def __init__(self, dataMatrix, use_implementation = "density", similarity = None, **args):
        ...
        if similarity == "euclidean":
            ...
            if use_implementation == "cython":
                ...
                try:
                    from Clean.External_Libraries.Similarity import Compute_Similarity_Cython
